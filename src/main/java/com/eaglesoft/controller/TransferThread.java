...
public class TransferThread implements Runnable{
    ...
    //mysql数据库驱动配置
    private String mysqlDrive = "com.mysql.cj.jdbc.Driver";

    //sql server数据库驱动配置
    private String mssqlDrive = "com.mircosoft.sqlserver.jdbc.SQLServerDriver";
    ...
    public void run() {
        ...
        try{
            ...
            if("mysql".equals(config.getDatabaseType())){
                ...
                sourceCon = DriverManager.getConnection("jdbc:mysql://" + config.getSourceUrl(),config.getSourceUsername(),config.getSourcePassword());
                targetCon = DriverManager.getConnection("jdbc:mysql://" + config.getTargetUrl(),config.getTargetUsername(),config.getTargetPassword());
                ...
                sourceCon = DriverManager.getConnection("jdbc:mircosoft:sqlserver:" + config.getSourceUrl(),config.getSourceUsername(),config.getSourcePassword());
                targetCon = DriverManager.getConnection("jdbc:mircosoft:sqlserver:" + config.getTargetUrl(),config.getTargetUsername(),config.getTargetPassword());
            }else {
                throw new Exception();
            }
